...
function AppLayout() {
  ...
  return (
    <div className="relative min-h-screen bg-gray-100">
      <div className="mx-auto flex w-full flex-col overflow-auto md:max-w-7xl ">
        <div className="mb-2 mt-2 h-12 w-full border-b-2 bg-gray-200 pb-16">
          <Header />
        </div>
        <div className="flex">
